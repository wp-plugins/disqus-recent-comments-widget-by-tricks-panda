...
Add Disqus recent comments widget to your WordPress with our user-friendly plugin. Just install the plugin to your WordPress and visit Widget settings in Appearance menu to add our widget to your blog.
...
We used Disqus' original recent comment script for the widget.

== Screenshots ==

1. Disqus Recent Comment Widget On Back-end.
2. Disqus Recent Comment Widget On Front-end.